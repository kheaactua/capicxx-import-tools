...
with section("parse"):
    ...
    _install_type_args = {
        "pargs": {
            "nargs": "+",
            # I don't think these are flags, they're more like sub commands.  See if I can fix this
    ...
    additional_commands = {
        ...
        "codeformattingcheck": {
            "kwargs": {"EXCLUDE_DIRECTORIES": "+", "SOURCE_DIRECTORIES": "+"},
            "pargs": {"flags": [], "nargs": "*"},
            "spelling": "CodeFormattingCheck",
        },
        "codelintcheck": {
            "kwargs": {"EXCLUDE_DIRECTORIES": "+", "SOURCE_DIRECTORIES": "+"},
            "pargs": {"flags": [], "nargs": "*"},
            "spelling": "CodeLintCheck",
        },
        "findclangtools": {"pargs": {"nargs": 0}, "spelling": "FindClangTools"},
        "installclangtools": {"pargs": {"nargs": 0}, "spelling": "InstallClangTools"},
    }
